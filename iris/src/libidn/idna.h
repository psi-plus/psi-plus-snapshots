...
#define IDNA_ACE_PREFIX "xn--"
  ...
  /* Core functions */
  extern int idna_to_ascii_4i (const my_uint32_t * in, size_t inlen,
			       char *out, int flags);
  extern int idna_to_unicode_44i (const my_uint32_t * in, size_t inlen,
				  my_uint32_t * out, size_t * outlen, int flags);

  /* Wrappers that handle several labels */

  extern int idna_to_ascii_4z (const my_uint32_t * input,
  ...
  extern int idna_to_unicode_4z4z (const my_uint32_t * input,
				   my_uint32_t ** output, int flags);
