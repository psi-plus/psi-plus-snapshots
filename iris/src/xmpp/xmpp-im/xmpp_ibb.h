...
private:
    ...
    void waitForAccept(const Jid &peer, const QString &iq_id, const QString &sid, int blockSize, const QString &stanza);
...
private:
    ...
    void           doReject(IBBConnection *c, const QString &id, Stanza::Error::ErrorCond cond, const QString &);
};
...
public:
    ...
    void respondError(const Jid &, const QString &id, Stanza::Error::ErrorCond cond, const QString &text = "");
